...
Public Sub GTKForms
	...
	img.Bitmap = LoadBitmapResize(File.DirAssets,"joey4.png",img.Width,img.Height,False)
	...
	qrc.Color =  0x00ffffff
	qrc.TextColor = 0xff000000
	qrc.Gravity = Gravity.Left
	qrc.Text = ""
	mBase.AddView(qrc,0.05 * mBase.Width,0.12 * mBase.Height,0.91 * mBase.Width,0.67 * mBase.Height)
