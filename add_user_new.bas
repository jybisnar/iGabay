...
Public Sub GTKForms
	...
	rbtnYes.Text="QRadioButton7"
	mBase.AddView(rbtnNo,0.60 * mBase.Width,0.39 * mBase.Height,0.24 * mBase.Width,0.03 * mBase.Height)
	rbtnNo.Text="QRadioButton8"
