...
Public Sub GTKForms
	...
	Main.Bitmap = LoadBitmapResize(File.DirAssets,"joey1.png",Main.Width,Main.Height,true)
	mBase.AddView(btnManageUser,0.68 * mBase.Width,0.02 * mBase.Height,0.24 * mBase.Width,0.05 * mBase.Height)
